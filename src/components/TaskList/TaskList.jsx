...
const TaskList = () => {
  return (
    <div id='tasklist' className='h-[50%] flex items-center overflow-x-auto justify-start gap-5 flex-nowrap w-full py-5 mt-10'>
      <div className='shrink-0 h-full w-[20%] p-5 bg-green-400 rounded-xl'>
      ...
      <div className='shrink-0 h-full w-[20%] p-5 bg-red-400 rounded-xl'>
        <div className='flex justify-between items-center'>
          <h3 className='bg-red-600 text-sm px-3 py-1 rounded'>High</h3>
          <h4 className='text-sm'>20 feb 2024</h4>
        </div>
      ...
      <div className='shrink-0 h-full w-[20%] p-5 bg-blue-400 rounded-xl'>
        <div className='flex justify-between items-center'>
          <h3 className='bg-red-600 text-sm px-3 py-1 rounded'>High</h3>
          <h4 className='text-sm'>20 feb 2024</h4>
        </div>
